\begin{table}
\caption{Statistical comparison of random vs.\ time split per network and task: mean inflation (Random $-$ Time F1), significant inflation (Wilcoxon across models, $p<0.05$), and Cohen's $d$.}
\label{tab:q2_stats}
